...
// Set direction of pins using the gpio settings on the BeagleBone Black
// setting the pins to pinmux
// type /sys/class/gpio/ into cloud9 terminal for more details
